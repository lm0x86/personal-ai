...
import { Task, Event, Reminder, Person, Place, Document, Memory, Project, Thing, Organization, History } from '../types/entities.js';
...
router.use('/history', createEntityRouter<History>({
  entityType: 'history',
  idPrefix: ID_PREFIX.history,
}));
